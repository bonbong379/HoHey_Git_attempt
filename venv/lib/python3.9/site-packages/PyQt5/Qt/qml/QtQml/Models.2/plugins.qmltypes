...
Module {
 ...
 type: "int" }
        ...
        Signal {
            ...
            Parameter { name: "sourceParent";
 type: "QModelIndex" }
            Parameter { name: "sourceStart";
 type: "int" }
            Parameter { name: "sourceEnd";
 type: "int" }
            Parameter { name: "destinationParent";
 type: "QModelIndex" }
            Parameter { name: "destinationRow";
 type: "int" }
        }
        Signal {
            name: "rowsMoved"
 ...
 type: "int" }
            Parameter { name: "destinationParent";
 type: "QModelIndex" }
            Parameter { name: "destinationColumn";
 type: "int" }
        }
        Signal {
            name: "columnsMoved"
 ...
 type: "QVariant" }
    ...
    Component { name: "QAbstractListModel";
 ...
 isReadonly: true }
        Property { name: "name";
 type: "string" }
        Property { name: "includeByDefault";
 type: "bool" }
